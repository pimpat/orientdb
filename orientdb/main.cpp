...
//    Packet GPacket;
        ...
        *(int *)dtPacket->GPacket.ssid = -1;
        size = reqConnectMsg(dtPacket->GPacket.msg, NULL, NULL, 28, NULL, "root", "qwerty");
...
//    Packet GPacket;
        ...
        *(int *)dtPacket->GPacket.ssid = -1;
        size = reqDBOpenMsg(dtPacket->GPacket.msg, NULL, NULL, 28, NULL, dbName, "graph", "root", "qwerty");
        ret = write(dtPacket->Sockfd, &dtPacket->GPacket, 5+size);
